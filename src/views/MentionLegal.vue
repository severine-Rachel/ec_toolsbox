<template>
  <div>
    ...
    <p>
      ...
      dans le cadre de sa réalisation et de son suivi : <br />
      <strong
      ...
      la publication est une personne physique. <br />
      ...
      d’expression communication. <br />
    </p>

    <h4>Hébergement</h4>
    <p>
      ohv<br />
      77 BD VIVIER MERLE<br />
      69003 LYON 3EME<br />
      Capital de 10 069 020 €<br />
      Siret : 424 761 419 00151<br />
    </p>
    ...
    <p>
      ...
      l’ensemble des activités de la société. <br />
    ...
    <p>
      ...
      écrite préalable de Peggy Raffy-Hideux. <br />
    ...
    <p>
      ...
      l’apparition d’un bug ou d’une incompatibilité. <br />
      ...
      consécutifs à l’utilisation du site raffy-hideux.fr. <br />
    ...
    <p>
      ...
      raffy-hideux.fr. l’obligation ou non de fournir ces informations. <br />
      ...
      de l’utilisateur du site raffy-hideux.fr. <br />
      Le site susnommé est déclaré à la CNIL sous le numéro 2131979. <br />
      ...
      exigées ont été mises en place par Nathalie FLE. Pour plus d’informations,
...
@Component({})
export default class MentionLegale extends Vue {
