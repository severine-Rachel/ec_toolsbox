<template>
  <div>
    ...
    <div>
      ...
      <p>
        Le CV vidéo vous donne une occasion de vous démarquer, de mettre
        davantage de chances de votre côté. Il montre également que vous
        maîtrisez les nouveaux outils de communication, que vous vous exprimez
