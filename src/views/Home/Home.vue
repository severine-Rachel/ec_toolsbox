<template>
  <div>
    ...
    <p>Ce site à été réalisé dans le but de fournir des supports de cours pour les étudiants de GEII de l’IUT d’Angers et 
      ...
      Il pourra aussi permettre à des enseignants d’expression communication de trouver des idées pour leurs propres cours. Je fais 
      moi-même partie de l'association des enseignants de communication en IUT. 
