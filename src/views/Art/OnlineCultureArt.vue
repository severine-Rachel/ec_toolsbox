<template>
  <div>
    ...
    <p>
      ...
      des structures culturelles, et touchant tous les domaines de la création
    ...
    <p>
      <strong>
        <a
          href="https://www.panoramadelart.fr/"
          class="subtitle-link"
          target="_blank"
        >
    ...
    <p>
      <strong>
        <a
          ...
          target="_blank"
        >
          Docus gratuits sur l’art – Les Beaux-Arts <b-icon icon="box-arrow-right"></b-icon>
        </a>
      </strong>
    </p>
    <p>
    ...
    <p>
      <strong>
        <a
          href="https://podcast.ausha.co/bulle-d-art"
          class="subtitle-link"
          target="_blank"
        >
    ...
    <p>
      <strong>
        <a
          href="https://www.louvre.fr/images-du-louvre"
          class="subtitle-link"
          target="_blank"
        >
    ...
    <p>
      <ul>
        ...
        <li>Les musées du Vatican, pour réaliser, entre autres, une visite 360° de la Chapelle Sixtine</li>
      </ul>
    </p>
    <Footer></Footer>
  </div>
