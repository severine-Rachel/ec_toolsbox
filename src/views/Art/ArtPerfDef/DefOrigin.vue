<template>
  <div>
    <h4>II.	ORIGINES</h4>
       ...
       <p>
        ...
        <ul>
            ...
            <li>
                dans la mise en question des visions modernistes dans les années 1960 et 1970 marquées par la contestation politique et les revendications socio-culturelles des mouvements étudiant, féministe, pacifiste, noir, hippie, gay, etc.
            </li>
        </ul>
        Le mot dérive du latin pro forma ou per forma pour indiquer un événement qui s’accomplit à travers une forme.
    </p>
    <p><u>Dada au Cabaret Voltaire à Zurich :</u></p>
    <p>
        <b-icon icon="arrow-right"></b-icon> Dada at the Cabaret Voltaire
    </p>
    <p>
    ...
    <p><u>L’école du Bauhaus (Oskar Schlemmer en tête de file) :</u></p>
    <p>
    ...
    <p>
        <b-icon icon="arrow-right"></b-icon>  Yves Klein. Anthropométrie de l'époque bleue (1960) black & white
    </p>
    <b-row align-h="center">
        <iframe 
            width="560" 
            height="315" 
            src="https://www.youtube.com/embed/kj0BQD1oOG0" 
            frameborder="0" 
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" 
            allowfullscreen
        >
    ...
    <p class="text-vid"> Chaîne :  channel391</p>
    <p>
        La réduction des couleurs au bleu fait jouer à la matière picturale le rôle de l’air, du vide, duquel, pour Yves Klein, naissent la force de l’esprit et l’imagination. La "technique des pinceaux vivants", ou "anthropométrie", revient à laisser au corps humain le soin de faire le tableau, mettant ainsi l’artiste en retrait. Cette performance artistique révèle la conception singulière du monde que s’est forgée Klein à partir d’expériences parallèles (le judo fondé sur les forces et éléments naturels du cosmos) et la philosophie ésotérique (recherche des forces spirituelles qui gouvernent l’Univers).
    </p>
    <p><u>La série des Singing Sculpture (1970), Gilbert & George</u></p>
    <b-row align-h="center">
        <iframe 
            width="560" 
            height="315" 
    ...
    <p>
        ...
        <ul>
            ...
            <li>empêcher que leur art puisse se voir accorder un statut de relique dans les galeries et les musées, </li>
            <li>remettre en question la distance entre l’artiste et le public.</li>
        </ul>
        Ils comptent parmi les pionniers de la living statue, statue ou tableau vivant.e dans les arts de la rue.
    </p>
  </div>
</template>
